...
Skills / sub-agents likewise still trigger as configured. aide-memory just adds the persistent typed memory store underneath.
...
Path scoping uses glob patterns with **parent inheritance**:
