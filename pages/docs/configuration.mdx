...
aide-memory ships with defaults that work for most workflows. If something doesn't fit (chatty per-file recall, hard-block on first read, periodic Stop nudges), flip a knob.
