...
aide-memory ships a local MCP server with seven tools. The agent calls them during conversation; you can run the equivalent CLI commands. See [Reference](/docs/reference) for full details.
