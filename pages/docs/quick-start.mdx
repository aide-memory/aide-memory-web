...
- **Node.js 20 or later** for running aide-memory itself (the bundled CLI / hooks / MCP server are JavaScript). Node 18 hit end-of-life April 2026, so 20 is the new minimum. Your project's language doesn't matter; aide-memory works with any codebase.
