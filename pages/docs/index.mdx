...
Memories belong to your project, not to whichever tool you're using. The same `.aide/memories/` directory is read by Claude Code, Cursor, and Devin CLI today. Switch tools or hand off to a teammate and the memory store comes with the codebase.
