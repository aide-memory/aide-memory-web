...
As developers, we're always chasing the best model, the best tools, faster inference. But the bottleneck I keep hitting isn't any of those. It's context.

AI agents have made developers significantly more productive. But they've created a new kind of friction. You explain how the feature you're building ties into the rest of the system, the way you like to structure your code, the patterns to follow in this area, how testing works. The agent gets it. You ship great work together.

In a new session, the agent re-reads files it already read. It re-explores areas it explored yesterday. You re-explain the same things.

And the cost adds up beyond individual sessions. Critical decisions being made during conversations aren't being captured. Preferences, corrections, area knowledge, guidelines. So much valuable context lives and dies inside individual sessions. It doesn't persist. It doesn't flow to the next session, to a different tool, or to a teammate's agent when they pick up work in the same area.
